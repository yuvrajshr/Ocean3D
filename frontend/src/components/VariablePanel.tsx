...
export function VariablePanel({
  ...
  const activeLayers = useMemo<LayerItem[]>(() => {
    return activeLayerKeys
      .map((k) => {
        ...
        const isCurrentMeta = k === selected && fieldMeta;
        const minVal = isCurrentMeta && fieldMeta.value_range ? fieldMeta.value_range[0] : 0;
        const maxVal = isCurrentMeta && fieldMeta.value_range ? fieldMeta.value_range[1] : 30;
        ...
        return {
          ...
          timestamp: currentTime
            ...
            : "Live Scenario",
          temporalResolution: "10-Daily Analysis",
  ...
  }, [activeLayerKeys, variables, selected, fieldMeta, currentTime, layerVisibility, layerOpacity]);
